...
function getConfidenceLabel(score: number): {
  ...
  if (score >= 0.8)
    return { label: "High", color: "var(--success)", bg: "var(--success-bg)" };
  if (score >= 0.6)
    return { label: "Moderate", color: "var(--amber)", bg: "var(--amber-bg)" };
    ...
    >
      ...
      <div style={{ padding: "18px 20px" }}>
        ...
        {state === "low_confidence" && (
          ...
          >
            This result has low confidence. Key data gaps affect the reliability
            of the analysis. Treat findings as directional, not definitive.
          </p>
        )}
      </div>
